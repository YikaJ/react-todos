...
var Pattern = function Pattern(pattern, served, included, watched) {
...
var createPatternObject = function createPatternObject(pattern) {
  ...
  if (helper.isObject(pattern)) {
    if (pattern.pattern && helper.isString(pattern.pattern)) {
      return helper.isUrlAbsolute(pattern.pattern) ? new UrlPattern(pattern.pattern) : new Pattern(pattern.pattern, pattern.served, pattern.included, pattern.watched);
    }
