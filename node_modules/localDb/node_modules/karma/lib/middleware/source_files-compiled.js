...
var createSourceFilesMiddleware = function createSourceFilesMiddleware(filesPromise, serveFile,
/* config.basePath */basePath) {

  return function (request, response, next) {
    // TODO(vojta): serve files under urlRoot (also update the formatError)
    var requestedFilePath = querystring.unescape(request.url).replace(/\?.*$/, '').replace(/^\/absolute/, '').replace(/^\/base/, basePath);
