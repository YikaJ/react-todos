 ...
 */
var createProxyHandler = function createProxyHandler(proxy, proxyConfig, proxyValidateSSL, urlRoot, config) {
...
var createProxyHandlerFactory = function createProxyHandlerFactory( /* config */config, /* config.proxies */proxies,
/* config.proxyValidateSSL */validateSSL) {
  return createProxyHandler(new httpProxy.RoutingProxy({ changeOrigin: true }), proxies, validateSSL, config.urlRoot, config);
};
